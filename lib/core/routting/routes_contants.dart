class RoutesContants {
  ...
  static const String setFingurePrint = '/set-fingure-print';
  static const String setFaceidOrSkip = '/set-faceid-or-skip';
  static const String setFaceid = '/set-faceid';
  static const String setFaceidVerified = '/set-faceid-verified';
